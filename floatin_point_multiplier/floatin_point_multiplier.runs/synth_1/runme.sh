...
HD_PWD='Z:/EE26/floatin_point_multiplier/floatin_point_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_interface.tcl
