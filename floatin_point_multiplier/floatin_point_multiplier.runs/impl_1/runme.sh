...
HD_PWD='Z:/EE26/floatin_point_multiplier/floatin_point_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_interface.tcl -notrace
