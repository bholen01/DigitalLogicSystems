...
#
# Generated by Vivado on Mon Mar 05 18:47:40 -0500 2018
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="Z:/EE26/floatin_point_multiplier/floatin_point_multiplier.cache/compile_simlib/activehdl"
  fi
