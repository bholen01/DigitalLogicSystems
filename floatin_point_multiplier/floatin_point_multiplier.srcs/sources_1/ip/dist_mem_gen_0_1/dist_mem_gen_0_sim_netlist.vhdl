...
-- Date        : Mon Mar  5 18:52:44 2018
-- Host        : lab225C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               z:/EE26/floatin_point_multiplier/floatin_point_multiplier.srcs/sources_1/ip/dist_mem_gen_0_1/dist_mem_gen_0_sim_netlist.vhdl
...
architecture STRUCTURE of dist_mem_gen_0_dist_mem_gen_v8_0_12 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 31 downto 15 );
begin
  dpo(31) <= \<const0>\;
  dpo(30) <= \<const0>\;
  dpo(29) <= \<const0>\;
  ...
  spo(27) <= \^spo\(29);
  spo(26) <= \^spo\(29);
  spo(25 downto 17) <= \^spo\(25 downto 17);
  spo(16) <= \<const0>\;
  spo(15) <= \^spo\(15);
  spo(14) <= \<const0>\;
  spo(13) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_12_synth
     port map (
      a(3 downto 0) => a(3 downto 0),
      spo(12 downto 10) => \^spo\(31 downto 29),
      spo(9 downto 1) => \^spo\(25 downto 17),
      spo(0) => \^spo\(15)
    );
end STRUCTURE;
library IEEE;
